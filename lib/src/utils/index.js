...
const generateTokenMintInstructions = (connection, walletPubKey, authority, freezeAuthority, decimals, poolTokenMintKeypair = null) => __awaiter(void 0, void 0, void 0, function* () {
    let tokenMint;
